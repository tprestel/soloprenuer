...
FEATURES
• One-click save — saves all tabs in your current window instantly
• Automatic backups — keeps your last 5 saves as safety copies
• Keyboard shortcut — Alt+Shift+T to save tabs without touching the mouse
• Tab groups — each save is a dated group you can expand, restore, or delete
• Export — download your tabs as JSON, Markdown, or HTML
• Import — load tabs from JSON files or OneTab format
• Badge count — see how many tab groups you have saved at a glance
...
## Tags
tabs, tab manager, save tabs, restore tabs, tab groups, OneTab alternative
